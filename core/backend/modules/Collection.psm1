#
# Module: Collection.psm1 v28.2.0 (Audit Sprint — M11 Hardened)
#
...
function Invoke-LogCollection {
    ...
    # ISSUE-004 FIX: High-resolution name with GUID suffix prevents collisions during concurrent execution.
    $archiveName = "$(Get-Date -Format 'HH-mm-ss-fff')_$([guid]::NewGuid().ToString('N').Substring(0,8))"
